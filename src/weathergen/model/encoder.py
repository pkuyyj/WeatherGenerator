...
class EncoderModule(torch.nn.Module):
    ...
    def assimilate_local(
        ...
        # Seed latents directly in the configured compute dtype. These tensors
        # otherwise remain float32 through the rollout because their construction
        # does not carry an autocast policy.
        latent_dtype = (
